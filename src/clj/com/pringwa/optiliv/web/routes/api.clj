(ns com.pringwa.optiliv.web.routes.api
  (:require
    ...
    [com.pringwa.optiliv.web.controllers.list-property :as list-property]
    [com.pringwa.optiliv.web.controllers.login :as login]
    [com.pringwa.optiliv.web.controllers.logout :as logout]
    [com.pringwa.optiliv.web.controllers.properties :as properties]
    [com.pringwa.optiliv.web.controllers.register :as register]
